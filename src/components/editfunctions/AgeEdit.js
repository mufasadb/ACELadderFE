...
const AgeEdit = (props) => {
    ...
    const [value, setValue] = React.useState(props.character.age);
    ...
    const handleRandom = () => {
        ...
        try {
            fetch(`http://localhost:3000/api/v1/npc/${props.character.id}/edit/age`, myInit)
                .then((res) => {
                    return res.json()
