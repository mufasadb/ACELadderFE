...
const JobEdit = (props) => {
    ...
    const [value, setValue] = React.useState(props.character.job);
    ...
    const handleRandom = () => {
        ...
        try {
            fetch(`http://localhost:3000/api/v1/npc/${props.character.id}/edit/job`, myInit)
                .then((res) => {
                    return res.json()
