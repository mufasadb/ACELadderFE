...
const VoiceEdit = (props) => {
    // const classes = useStyles();
    const [value, setValue] = React.useState(props.character.voice);
    ...
    const handleCheck = () => {
        ...
        submitableCharacter.voice = value
    ...
    const handleRandom = () => {
        ...
        try {
            fetch(`http://localhost:3000/api/v1/npc/${props.character.id}/voice`, myInit)
                .then((res) => {
                    return res.json()
