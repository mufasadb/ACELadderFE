...
const LocationEdit = (props) => {
    ...
    const [value, setValue] = React.useState(props.character.location);
    ...
    const handleCheck = () => {
        ...
        submitableCharacter.location = value
    ...
    const handleRandom = () => {
        ...
        try {
            fetch(`http://localhost:3000/api/v1/npc/${props.character.id}/location`, myInit)
                .then((res) => {
                    return res.json()
