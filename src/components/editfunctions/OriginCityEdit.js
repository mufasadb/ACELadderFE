...
const OriginCityEdit = (props) => {
    // const classes = useStyles();
    const [value, setValue] = React.useState(props.character.originCity);
    ...
    const handleCheck = () => {
        ...
        submitableCharacter.originCity = value
    ...
    const handleRandom = () => {
        ...
        try {
            fetch(`http://localhost:3000/api/v1/npc/${props.character.id}/originCity`, myInit)
                .then((res) => {
                    return res.json()
