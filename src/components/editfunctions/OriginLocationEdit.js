...
const OriginLocationEdit = (props) => {
    // const classes = useStyles();
    const [value, setValue] = React.useState(props.character.originLocation);
    ...
    const handleCheck = () => {
        ...
        submitableCharacter.originLocation = value
    ...
    const handleRandom = () => {
        ...
        try {
            fetch(`http://localhost:3000/api/v1/npc/${props.character.id}/originLocation`, myInit)
                .then((res) => {
                    return res.json()
...
export default OriginLocationEdit;